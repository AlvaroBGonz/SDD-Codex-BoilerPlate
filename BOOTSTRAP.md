...
Verify custom Codex commands exist
...
# 12 Troubleshooting
Codex commands not visible

If /opsx:* or /ai-specs:* commands are not detected:

Make sure Codex opened the project root (where .codex/ exists)

Ensure Workspace Trust is enabled

Restart VS Code

Confirm you are using Codex in this project root
