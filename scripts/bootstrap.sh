...
if [[ ! -d ".codex/commands" ]]; then
  echo "❌ ERROR: .codex/commands directory not found."
...
# ------------------------------------------------------------
OPSX_DIR=".codex/commands/opsx"
AISPECS_DIR=".codex/commands/ai-specs"
...
DEFAULT_MARKER=".codex/commands/default"
...
echo "3) Open Codex in this project root."
echo "4) Type '/' in Codex to verify commands are detected."
echo
echo "IMPORTANT:"
